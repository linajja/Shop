...
function ProductEdit() {
    const { modalProductData, setModalProductData, setEditProductData } =
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <button
                            type="button"
                            className="close"
                            onClick={() => setModalProductData(null)}
                        >
                    ...
                    <div className="modal-footer">
                        <button
                            type="button"
                            className="btn btn-outline-secondary fu up"
                            onClick={() => setModalProductData(null)}
                        >
                            Uždaryti
                        </button>
                        <button
                            type="button"
                            className="btn btn-outline-primary fu up"
                            onClick={edit}
                        >
                            Išsaugoti
                        </button>
